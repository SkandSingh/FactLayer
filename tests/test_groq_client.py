"""Tests for app.llm.groq_client.GroqClient.
...
Run: python -m pytest tests/test_groq_client.py -v
"""
import asyncio
...
def _no_real_sleep(monkeypatch):
    ...
    monkeypatch.setattr("app.llm.groq_client.asyncio.sleep", _fake_sleep)
...
def test_generate_returns_text_from_successful_response(client, monkeypatch):
    flaky = _FlakyPost(fail_times=0, result="hello from groq")
